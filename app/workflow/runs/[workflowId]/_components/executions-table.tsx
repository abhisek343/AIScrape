...
import ChaosHistoryChart from '@/app/workflow/runs/[workflowId]/_components/chaos-history-chart';
...
type ExecutionRow = NonNullable<InitialDataType>[number];
...
export default function ExecutionsTable({
  ...
  return (
    <div className="space-y-4">
      <ChaosHistoryChart executions={query.data} />
            ...
            {(query.data as ExecutionRow[]).map((execution) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex flex-col">
                      <span className="font-semibold">{execution.chaosScore ?? '-'}</span>
                      <span className="text-xs text-muted-foreground">
                        {typeof execution.chaosPredictedSuccess === 'number'
                          ? `${execution.chaosPredictedSuccess.toFixed(1)}% success`
                          : 'No snapshot'}
                      </span>
                    </div>
                  </TableCell>
